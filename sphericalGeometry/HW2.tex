...
For the hyperbolic paraboloid, the principal curvatures go in \wordChoice{\choice[correct]{the same direction}\choice{opposite directions}}, so its Gaussian curvature is 
negative.  
...
\item In Euclidean geometry, such a triangle \wordChoice{\choice{can}\choice[correct]{cannot}} exist where \emph{every} triangle has an angle sum equal to $180^\circ$.  
...
\begin{itemize}
\item In hyperbolic geometry, the two perpendiculars \wordChoice{\choice[correct]{will be}\choice{might be}\choice{cannot be}} parallel.    
\item In Euclidean geometry, the two perpendiculars \wordChoice{\choice[correct]{will be}\choice{might be}\choice{cannot be}} parallel.  
\item In spherical geometry, the two perpendiculars \wordChoice{\choice{will be}\choice{might be}\choice[correct]{cannot be}} parallel 
\end{itemize}
\begin{problem}
