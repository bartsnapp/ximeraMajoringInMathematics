...
\title[Activity:]{Sums and products combined}
...
%% \begin{problem}
%% Finally we encountered several sequences of numbers including
%% \begin{align*}
%%   &\{ 1, 3, 7, 15, 63,\dots\}\\
%%   &\{ 2, 4, 8, 16, 64,\dots\}\\
%%   &\{ 1, 5, 23, 119, 719,\dots\}\\
%%   &\{ 1, 2, 6, 24, 120,\dots\}
%% \end{align*}
%% Look these sequences up at \link{https://oeis.org/}{https://oeis.org/}. Find something interesting at the OEIS and tell us about it.
%% \begin{freeResponse}
%% \end{freeResponse}
