...
With this new language, the sum of the roots taken one at a time is the same as the sum of the roots.  Furthermore, for a cubic polynomial, the sum of the roots taken three at a time is the same as the product of the roots.  

This idea generalizes to polynomials of degree $n$:  The coefficient of $x^{n-k}$ is $(-1)^k$ times the sum of the roots taken $k$ at a time.  \textbf{Cool Stuff!!}
