...
\begin{problem}
Is $\star$ a commutative operation?  $\answer[format=string]{yes}$
...
\begin{problem}
Is $\star$ an associative operation?  $\answer[format=string]{yes}$
...
and commutative, the order that we choose numbers \wordChoice{\choice{does} \choice{does not}} matter.

Furthermore, if we continue choosing numbers until only one remains, that last number will be 
\[
