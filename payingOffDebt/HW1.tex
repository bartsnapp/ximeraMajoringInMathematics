...
For the remaining questions, please read this description of a 
\href{https://studentaid.gov/announcements-events/save-plan}{new student loan repayment program} 
and this October 4, 2023, 
\href{https://www.whitehouse.gov/briefing-room/statements-releases/2023/10/04/president-biden-announces-an-additional-9-billion-in-student-debt-relief-for-125000-americans/}{Whitehouse press release}.  
...
What does AGR stand for?  $\answer[format=string]{adjusted gross income}$. Hint: 3 words. 
...
\begin{selectAll}
\choice{Your loan balance will get larger.}
\choice{Your next payment will need to be larger.}
\choice{The interest will be larger the following month.}
\choice[correct]{The government covers the rest of the interest that accrued that month.}
\choice[correct]{The SAVE Plan prevents your balance from growing due to unpaid interest.}
\end{selectAll}
\end{question}
\end{question}

\begin{question}
Although the Supreme Court struck down the Biden administration's plan to provide broad debt relief of \$10,000 to most borrowers and \$20,000 to Pell Grant recipients, more targeted debt relief has been aimed at what categories of borrowers?  
\begin{selectAll}
\choice{Borrowers from institutions in the PAC-12, SEC, or from Michigan}
...
\choice[correct]{Borrowers who were cheated by their institutions or whose institutions closed}
\end{selectAll}
\begin{feedback}[incorrect]
Be sure to read to the bottom of the press release.
\end{feedback}
\begin{question}
Correct!  As of October 4, 2023, the Biden-Harris Administration has approved $\answer{127}$ billion dollars in debt cancellation for nearly $\answer{3.6}$ million borrowers.  
\end{question}
